...
const RULES_SECTIONS = [
  { icon: '🏦', title: 'ניקוד — איך זה עובד', items: ['ניחוש כיוון נכון (בית / תיקו / חוץ) = +3 נק׳','ניחוש תוצאה מדויקת = +5 נק׳','ניחוש שגוי = 0 נק׳ (לא מפסיד נקודות!)','הנקודות מצטברות לאורך כל העונה'] },
  { icon: '⚽', title: 'הימור על משחק', items: ['בחר ניצחון בית / תיקו / ניצחון חוץ','ניתן גם לנחש תוצאה מדויקת (לא חובה) — 5 נק׳ במקום 3','הימורים נסגרים עם תחילת המשחק','ניתן לבטל הימור לפני תחילת המשחק','שכחת להמר? המערכת תמר עבורך אוטומטית לפני הקיקאוף'] },
  { icon: '🏆', title: 'ניחושי ליגה (מיוחדים)', items: ['ניחוש אלוף הליגה — נפתח בתחילת העונה','ניחוש שתי הקבוצות היורדות — נפתח בתחילת העונה','ניחוש מלך השערים — נפתח בתחילת העונה','ניחוש נכון = בונוס נקודות בסוף העונה','אין ניכוי נקודות על ניחוש שגוי'] },
  { icon: '🐒', title: 'הקוף', items: ['שחקן וירטואלי בשם "🐒 קוף" מתחרה עם כולם','הקוף מנחש רנדומלית לפני כל משחק','בסוף העונה — האם הצלחת לנצח את הקוף?'] },
  { icon: '📊', title: 'טבלת הדירוג', items: ['הדירוג נקבע לפי סך הנקודות שנצברו','✓ = מספר ניחושי כיוון נכונים','✗ = מספר ניחושי כיוון שגויים','🎯 = מספר תוצאות מדויקות','שיוויון בנקודות — מכריע: ✓ → 🎯'] },
  { icon: '📅', title: 'על הטורניר', items: ['ליגת העל הישראלית — עונת 2026/27','14 קבוצות, 26 מחזורים בשלב העונה הסדירה','כל מחזור — 7 משחקים להמר עליהם','בחר את קבוצת הלב שלך ושנה את מראה האפליקציה'] },
];
